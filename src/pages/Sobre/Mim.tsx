  ...
  return (
    <PageTemplate title="Mim">
      <div className="max-w-2xl space-y-10">
        ...
        <div className="mb-16">
          <p className="text-white/90 font-light leading-tight">
            <strong className="text-2xl tracking-tighter block">DIN</strong>
            <span className="text-[10px] uppercase tracking-[0.4em] opacity-40">Artista</span>
          </p>
        </div>
        ...
        <div className="space-y-8 text-white/50 font-light leading-relaxed">
          ...
          <p className="pb-10">
            Irônico é que eu tinha feito um curso de “Administração” presencialmente lá atrás, e mesmo não gostando tanto no começo (Eu odiava), no final achei interessante, era um curso longo e completo, mas que eu deveria ter valorizado mais, afinal de contas hoje eu estou envolvido com, né. Tudo bem, é isso, um pouco sobre mim.
          </p>
        </div>
